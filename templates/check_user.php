                                ...
                                <div class="card mb-4 shadow-sm" style="background-color: white;">
                                    ...
                                    <div class="card-footer">
                                        <?php
                                            ...
                                            if($liked > 0){
                                                echo '<button class="btn btn-primary like" disabled data-like="'.$post_id.'"><i class="fa fa-thumbs-up"></i> '.$likes.'</button>
                                                <button class="btn btn-secondary share" disabled data-share="'.$post_id.'"><i class="fa fa-share-alt"></i> '.$shares.'</button>';
                                            }else{
                                                echo '<button class="btn btn-default like" disabled data-like="'.$post_id.'"><i class="fa fa-thumbs-up"></i> '.$likes.'</button>
                                                <button class="btn btn-secondary share" disabled data-share="'.$post_id.'"><i class="fa fa-share-alt"></i> '.$shares.'</button>';
                                            }
                                        ?>
                                    </div>
